...
import * as directApi from '@testing-library/user-event/dist/cjs/setup/directApi.js';
export type { Instance } from '@testing-library/user-event/dist/cjs/setup/setup.js';
